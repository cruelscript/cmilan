#ifndef CMILAN_SCANNER_HPP
#define CMILAN_SCANNER_HPP
...
enum Token
{
  ...
  T_RNUMBER,  // Вещественный литерал
  ...
  T_SEMICOLON,		// ";"
  T_INT,  // Целочисленный тип
  T_FLOAT,  // Вещественный тип
...
private:
  ...
  float floatValue_; //значение текущего вещественного
